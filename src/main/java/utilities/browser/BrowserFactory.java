...
public class BrowserFactory {
    ...
    private static String host = Helper.getProperty(propertiesFileName, "remote.execution.host");
    private static String port = Helper.getProperty(propertiesFileName, "remote.execution.port");
